        ...
        <div className='flex flex-1 flex-col items-center justify-center p-16'>
          <div className='w-full max-w-3xl text-center'>
            <div className='opacity-100 transform-none'>
              <svg
                className='MuiBox-root muiltr-aj27e4'
            ...
            <div className='opacity-100 transform-none'>
              <h1 className='MuiTypography-root MuiTypography-h1 mt-48 text-center text-4xl font-extrabold leading-tight tracking-tight sm:mt-96 md:text-7xl md:leading-none muiltr-1hmucd3'>
                Something went wrong!
              </h1>
            </div>
            <div className='opacity-100 transform-none'>
              <h5 className='MuiTypography-root MuiTypography-h5 mt-8 text-center text-lg font-medium tracking-tight md:text-xl muiltr-11pybn9'>
                Server Error 500. Our staff has been notified, thank you for
                your understanding.
              </h5>
            </div>
            <a
